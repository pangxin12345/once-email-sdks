...
namespace OnceEmail.Sdk.Client
{
    ...
    public class Configuration : IReadableConfiguration
    {
        ...
        {
            Proxy = null;
            UserAgent = WebUtility.UrlEncode("OpenAPI-Generator/0.1.0-private.1/csharp");
            BasePath = "https://api.once-email.com";
        ...
        public Configuration(
            ...
            string basePath = "https://api.once-email.com") : this()
        {
        ...
        {
            string report = "C# SDK (OnceEmail.Sdk) Debug Report:\n";
